...
def get_whois_info(domain: str) -> Dict[str, Any]:
    ...
    try:
        # python-whois can print low-level socket timeout messages directly to
        # stdout/stderr. Capture that library noise and return a clean result.
        ...
        message = str(e)
        if "timed out" in message.lower() or "socket" in message.lower():
            result["error"] = "WHOIS service timed out or was unavailable"
        else:
            result["error"] = f"WHOIS lookup failed: {message}"
